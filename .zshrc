...
if [ ! -f /usr/local/bin/brew ]; then
    echo "/usr/local/bin/brew was not found. Installing homebrew..."
    ruby -e "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install)"
fi

# Install omg zsh from homebrew to use. Instead of the default zsh.
if [ ! -f /usr/local/bin/zsh ]; then
    echo "/usr/local/bin/zsh was not found. Installing zsh from homebrew..."
    brew install zsh
...
# Sauce Labs
export SAUCE_USER=sso-splunk.saucelabs.com-glouie
# export SAUCE_API_KEY=bcff1897-40f2-43b8-98cb-6cb010f7ac62
export SAUCE_API_KEY=cd596a3e-73a5-400f-8635-b795a8687594
...
export GITLAB_HOST='cd.splunkdev.com'
export GITLAB_TOKEN='h1AeLrbMYJ6PBZh3zKjJ'
export GITLAB_PERSONAL_TOKEN='h1AeLrbMYJ6PBZh3zKjJ'
